...
public class TokenRenewalTest_doasBlock_cleanUgi_oldApi extends Configured implements Tool {

    int failFlags = 10000; // test result init but not updated yet

  public static void main(String[] args) throws Exception {
    int ret = ToolRunner.run(new TokenRenewalTest_doasBlock_cleanUgi_oldApi(), args);
    System.exit(ret-10000); // if no errors, this will be 0
  }

  public int run(String [] args) throws Exception {

    JobConf conf = new JobConf(TokenRenewalTest_doasBlock_cleanUgi_oldApi.class);
    ...
    public void go() throws Exception {
      ...
      String retVal = ugi.doAs(new PrivilegedExceptionAction<String>() {
        public String run() throws Exception {
           ...
           JobConf doasConf = new JobConf(TokenRenewalTest_doasBlock_cleanUgi_oldApi.class);
           JobClient doasJobclient = new JobClient(doasConf);

           doasConf.setJarByClass(TokenRenewalTest_doasBlock_cleanUgi_oldApi.class);
           doasConf.setJobName("TokenRenewalTest_doasBlock_cleanUgi_oldApi_wordcountDoasUser_job1");
           ...
           JobConf doasConf2 = new JobConf(TokenRenewalTest_doasBlock_cleanUgi_oldApi.class);
           JobClient doasJobclient2 = new JobClient(doasConf2);

           doasConf.setJarByClass(TokenRenewalTest_doasBlock_cleanUgi_oldApi.class);
           doasConf.setJobName("TokenRenewalTest_doasBlock_cleanUgi_oldApi_wordcountDoasUser_job2");
