...
a = load 'webhdfs://axonitered-nn1.red.ygrid.yahoo.com/user/patwhite/PigTez/cube_rollup_5.data' using PigStorage('') as (col1:chararray,col2:chararray,col3:int,col4:int,col5:float,col6:float,col7:int,col8:int,col9:chararray,col10:int,col11:chararray,col12:chararray,col13:int,col14:int,col15:float,col16:float,col17:int,col18:int,col19:chararray,col20:int);
