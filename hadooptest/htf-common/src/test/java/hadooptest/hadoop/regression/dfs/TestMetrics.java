...
public class TestMetrics extends DfsTestsBaseClass {
	...
	TestSession.logger.info("The jar file being copied is: " + workspace + "/hadooptest/htf-common/resources/misc/jmxterm-1.0-SNAPSHOT-uber.jar ");
	String[] jar_cmd = {"ls", "-l", workspace + "/hadooptest/htf-common/resources/misc/jmxterm-1.0-SNAPSHOT-uber.jar "};
	TestSession.logger.info("Running ls -l on gateway: ");
	String[] output_ls = TestSession.exec.runProcBuilder(jar_cmd);
	...
	String[] cmd = { "/usr/bin/scp", workspace + "/hadooptest/htf-common/resources/misc/jmxterm-1.0-SNAPSHOT-uber.jar ", namenodeHostname + ":/tmp/"} ;
