...
public class TestCrossColoReplicationWithDistCpStrategyOnStaging extends TestSession {
    ...
    private final String dataSetName = "TestCrossColoRepl_" + System.currentTimeMillis();
