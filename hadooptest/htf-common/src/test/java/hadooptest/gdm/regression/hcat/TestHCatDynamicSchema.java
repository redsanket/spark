...
public class TestHCatDynamicSchema  extends TestSession {
	...
	public void testInstanceWithDynamicSchema() throws Exception {
		 ...
		 // FIRST_INSTANCE workflow 
		{
			// acquisition workflow
			{
				...
				boolean isAcqusitionTableCreated = this.hcatHelperObj.isTableExists(this.acquisitionHCatServerName, this.dataSetName);
				...
				boolean isAcquisitionFirstInstancePartitionCreated = this.hcatHelperObj.isPartitionIDExists(this.acquisitionHCatServerName , this.acquisitionTableName , FIRST_INSTANCE);
				...
				this.fistInstanceAcquisitionSchemaJSONArray = this.hcatHelperObj.getHCatTableColumns(this.acquisitionHCatServerName , this.acquisitionTableName); 
			}
			...
			// replication workflow
			{
				...
				boolean isReplicationTableCreated = this.hcatHelperObj.isTableExists(this.replicationHCatServerName, this.dataSetName);
				...
				boolean isReplicationFirstInstancePartitionCreated = this.hcatHelperObj.isPartitionIDExists(this.replicationHCatServerName , replicationTableName , FIRST_INSTANCE);
				...
				this.fistInstanceReplicationSchemaJSONArray = this.hcatHelperObj.getHCatTableColumns(this.replicationHCatServerName , this.replicationTableName); 
			}
		}
		...
		// check workflow for second instance
		{
			...
			boolean isAcquisitionSecondInstancePartitionCreated = this.hcatHelperObj.isPartitionIDExists(this.acquisitionHCatServerName , this.acquisitionTableName , SECOND_INSTANCE);
			...
			this.secondInstanceAcqusisitionSchemaJSONArray =  this.hcatHelperObj.getHCatTableColumns(this.acquisitionHCatServerName , this.acquisitionTableName); 
			...
			// check for SECOND_INSTANCE created for acquisition hcat
			boolean isReplicationSecondInstancePartitionCreated = this.hcatHelperObj.isPartitionIDExists(this.replicationHCatServerName , this.replicationTableName , SECOND_INSTANCE);
			...
			this.secondInstanceReplicationSchemaJSONArray =  this.hcatHelperObj.getHCatTableColumns(this.replicationHCatServerName , this.replicationTableName); 
		...
		// check for third instance workflow
		{
			...
			boolean isAcquisitionThirdInstancePartitionCreated = this.hcatHelperObj.isPartitionIDExists(this.acquisitionHCatServerName , this.acquisitionTableName , THIRD_INSTANCE);
			...
			// check for SECOND_INSTANCE created for acquisition hcat
			boolean isReplicationThirdInstancePartitionCreated = this.hcatHelperObj.isPartitionIDExists(this.replicationHCatServerName , this.replicationTableName , THIRD_INSTANCE);
	...
	public static void createFDIServer() throws Exception {
		...
		String dataSource = console.getDataSourcetXml(fdiServerName);
		if (dataSource == null) {
			...
			dataSource = console.getDataSourcetXml(fdiServerName);
			if (dataSource == null) {
