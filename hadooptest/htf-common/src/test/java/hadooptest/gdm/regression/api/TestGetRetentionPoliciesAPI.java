...
public class TestGetRetentionPoliciesAPI  extends TestSession {
	...
	public void setup() throws Exception {
		...
		dataSourceList = this.consoleHandle.getAllInstalledGridName();
	}
	...
	public void testMultipleResourceName() {
		TestSession.logger.info("datasets = " + this.dataSetList.subList(0, 2) );
		String resourceName = this.jsonUtil.constructResourceNamesParameter(this.dataSetList.subList(0, 2));
		TestSession.logger.info("resourceName  = "  + resourceName);
