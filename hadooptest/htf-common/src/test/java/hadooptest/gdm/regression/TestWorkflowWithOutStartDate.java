...
/**
 * TestCase :  Verify whether acquisition and replication workflow works as expected when start date is not specified.
 * bug id : http://bug.corp.yahoo.com/show_bug.cgi?id=7228072
 * 
 */
public class TestWorkflowWithOutStartDate extends TestSession {
    ...
    private String END_DATE;  // needed for end date
    ...
    public void setUp() throws NumberFormatException, Exception {
        ...
        this.dataSetName = "TestWorkFlowForMissingStartDate_" + System.currentTimeMillis();
    ...
    @Test
    public void testWorkflowWithOutStartDate() throws Exception {
    ...
    public void createDataSetForAcqRep( ) throws Exception {
        ...
        dataSetXml = dataSetXml.replaceAll("start=\"START_DATE\"", "" );
