				...
				if (recordCount == 0) {
					...
					if (dbTableColumnsReplicaList.size() > -1) {
						...
						insertFinalResultIntoDB(
								...
								dbTableColumnsReplicaObject.getPigVersion(),dbTableColumnsReplicaObject.getPigCurrentState(),
								dbTableColumnsReplicaObject.getPigMRJobURL(), dbTableColumnsReplicaObject.getPigResult(),
								dbTableColumnsReplicaObject.getPigComments(),
