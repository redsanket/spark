...
/**
 * TestCase : Verify whether  <HCatTargetType>DataOnly</HCatTargetType> only copies data on to the grid
 * 			  and does not create HCAT table either for acquisition and replication.
 *
 */
public class TestHCatTargetTypeDataOnly extends TestSession {
	...
	public void setUp() throws NumberFormatException, Exception {
		...
		this.dataSetName = "TestHCatTargetTypeDataOnly_" + System.currentTimeMillis();
	...
	@Test
	public void testHcatDataOnlyTargetType() throws Exception {
		...
		{	
			...
			boolean flag = this.hcatHelperObject.isTableExists("acquisition", this.dataSetName, this.targetGrid1);
			assertTrue("Expected false but got " + flag , flag == false);
		}
		...
		{	
			...
			boolean flag = this.hcatHelperObject.isTableExists("replication", this.dataSetName, this.targetGrid2);
			assertTrue("Expected false but got " + flag , flag == false);
		}
	}
