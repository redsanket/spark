 ...
 * example :  data/daqdev/data/%{date}1234_extra_path/PAGE/ 
 *   
 */
public class TestDiscoveryPathSpecifiedAfterDateWithExtraStringSpecified extends TestSession {
	...
	public void testDoAcqAndRep() throws Exception {
		...
		// construct the path to verify with the replication workflow path
		String path = this.CUSTOM_PATH + this.dataSetName + "/" + instanceDates.get(0) + "1234_extra_path/PAGE";
	...
	/**
	 * Method to create a custom path with date and extra string in path.
	 * @param pathType - its a string type which represents either data/count/schema
	 * @param dataSet - dataset name
	 * @return
	 */
	private String getCustomPath() {
		return  CUSTOM_PATH + this.dataSetName + "/%{date}1234_extra_path/PAGE/";
	}
