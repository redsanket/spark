    ...
    <div>
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="http://openqe48blue-n9.blue.ygrid.yahoo.com:8080/HealthCheckUpHistory.jsp">Hadoop Pipeline</a></li>
            <li><a href="http://openqe53blue-n9.blue.ygrid.yahoo.com:8080/HealthCheckUpHistory.jsp">Pineline-2</a></li>
          </ul>
        </li>
...
%>
		<br>
		 <script type="text/javascript">
		 	$(document).ready(function() {
     			var table = $('#health-CheckUp-History-Table').dataTable();
			} );
		 </script>
		<br>
		<%
		...
		%>
				<%
					...
					final String SELECT_QUERY = "select distinct * from health_checkup";
				  	try {
				  %>
				  <%
				...
				%> --%>
							...
							<div class="container-fluid">
							<table id="health-CheckUp-History-Table" class="table table-bordered table-hover table-striped">
							<thead>
								<tr>
