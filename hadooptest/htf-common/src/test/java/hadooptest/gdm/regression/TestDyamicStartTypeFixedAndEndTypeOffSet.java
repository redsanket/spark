...
/**
 * 
 * TestCase : Verify whether facet workflow ( acquisition and replication ) are completed, when targets StartType is Fixed and EndType is offset. 
 *
 */
public class TestDyamicStartTypeFixedAndEndTypeOffSet extends TestSession {
