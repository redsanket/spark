...
<nav class="navbar navbar-inverse">
  ...
  %>
  		<%
  			SELECT_QUERY = "select * from integrationFinalResult  where date like  "  + "\"" + dateParameterValue +  "\"";
  		%>
  <%
  	}  
  %>
			...
			%>
				...
				<tr>
					<td class="text-center">
						 ...
						 <a href="ModifyComment.jsp?dataSetName=<%= dataSetName %>" target="_blank"><%= dataSetName.trim() %></a>
					</td>
					<td class="text-center">
					<%= date %>
					</td>
