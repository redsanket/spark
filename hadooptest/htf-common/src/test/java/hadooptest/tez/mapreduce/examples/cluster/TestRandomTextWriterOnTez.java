...
public class TestRandomTextWriterOnTez extends TestSession {
	/**
	 * This test class is there to check for backward compatibility, to ensure
	 * that legacy MR jobs continue to run on Tez, with the framework set to
	 * yarn-tez
	 * 
	 * This program uses map/reduce to just run a distributed job where there is
	 * no interaction between the tasks and each task writes a large unsorted
	 * random sequence of words. In order for this program to generate data for
	 * terasort with a 5-10 words per key and 20-100 words per value, have the
	 * following config: <xmp> <?xml version="1.0"?> <?xml-stylesheet
	 ...
	 * </property> <property>
	 * <name>mapreduce.randomtextwriter.maxwordskey</name> <value>10</value>
	 * </property> <property>
	 * <name>mapreduce.randomtextwriter.minwordsvalue</name> <value>20</value>
	 * </property> <property>
	 * <name>mapreduce.randomtextwriter.maxwordsvalue</name> <value>100</value>
	 * </property> <property> <name>mapreduce.randomtextwriter.totalbytes</name>
	 * <value>1099511627776</value> </property> </configuration></xmp>
	 * 
	 * Equivalently, {@link RandomTextWriter} also supports all the above
	 * options and ones supported by {@link Tool} via the command-line.
	 * 
