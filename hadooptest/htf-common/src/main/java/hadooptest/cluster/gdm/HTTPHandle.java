...
public class HTTPHandle
{
	...
	protected final PostMethod makePOST(String paramString1, String paramString2, ArrayList<CustomNameValuePair> paramArrayList)
	{
	...
	protected final PostMethod makePOST(String paramString1, String paramString2, String paramString3) {
		String str = new StringBuilder().append(this.baseURL).append(paramString1).toString();
