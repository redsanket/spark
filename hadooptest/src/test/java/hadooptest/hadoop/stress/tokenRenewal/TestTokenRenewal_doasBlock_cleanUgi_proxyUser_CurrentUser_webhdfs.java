...
public class TestTokenRenewal_doasBlock_cleanUgi_proxyUser_CurrentUser_webhdfs extends TestSession {
	...
	private static String input_string = "Hello world! Run doasBlock proxyUser CurrentUser Webhdfs!";
