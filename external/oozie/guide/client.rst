...
the `Command-Line Interface Utilities documentation <https://kryptonitered-oozie.red.ygrid.yahoo.com:4443/oozie/docs/DG_CommandLineTool.html>`_.
...
See also `Checking the Status of multiple Workflow Jobs <https://kryptonitered-oozie.red.ygrid.yahoo.com:4443/oozie/docs/DG_CommandLineTool.html#Checking_the_Status_of_multiple_Workflow_Jobs>`_.
...
See also `Coordinator Job <https://kryptonitered-oozie.red.ygrid.yahoo.com:4443/oozie/docs/CoordinatorFunctionalSpec.html#a6.1.2._Coordinator_Job>`_
and `Coordinator Action Status <https://kryptonitered-oozie.red.ygrid.yahoo.com:4443/oozie/docs/CoordinatorFunctionalSpec.html#a6.1.3.2._Coordinator_Action_Status>`_.
...
XML <https://kryptonitered-oozie.red.ygrid.yahoo.com:4443/oozie/docs/DG_CommandLineTool.html#Validating_a_Workflow_XML>`_.
...
See `SLA Operations <https://kryptonitered-oozie.red.ygrid.yahoo.com:4443/oozie/docs/DG_CommandLineTool.html#SLA_Operations>`_
for more examples.
...
See `Submitting a pig job through HTTP <https://kryptonitered-oozie.red.ygrid.yahoo.com:4443/oozie/docs/DG_CommandLineTool.html#Submitting_a_pig_job_through_HTTP>`_
for another example.
