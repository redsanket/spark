...
sed 's/[$()]//g' ${SRCTOP}/hadooptest/htf-common/resources/gdm/conf/config.xml > ${SRCTOP}/hadooptest/htf-common/resources/gdm/conf/config.xml.1
sed "s/STARLING_HOST_NAME/${STARLING_HOST_NAME}/g" ${SRCTOP}/hadooptest/htf-common/resources/gdm/conf/config.xml.1 > ${SRCTOP}/hadooptest/htf-common/resources/gdm/conf/config.xml

sed 's/[$()]//g' ${SRCTOP}/hadooptest/htf-common/resources/gdm/conf/config.xml > ${SRCTOP}/hadooptest/htf-common/resources/gdm/conf/config.xml.1
sed "s/STARLING_LOGS_TO_TEST/${STARLING_LOGS_TO_TEST}/g" ${SRCTOP}/hadooptest/htf-common/resources/gdm/conf/config.xml.1 > ${SRCTOP}/hadooptest/htf-common/resources/gdm/conf/config.xml
