...
fanout_root "sed -i \"s/HBASE_CONF_DIR=\/home\/gs\/conf\/hbase/HBASE_CONF_DIR=\/home\/y\/libexec\/hbase\/conf/g\" /etc/profile.d/grid.sh"
fanout_root "sed -i \"s/HBASE_CONF_DIR=\/home\/y\/conf\/hbase/HBASE_CONF_DIR=\/home\/y\/libexec\/hbase\/conf/g\" /etc/profile.d/grid.sh"
