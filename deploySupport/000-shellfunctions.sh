...
fanout() {
	...
	[ -n "$HOSTLIST" ] && $PDSH_SLOW -w "$HOSTLIST" $*
...
fanoutHBASEZOOKEEPER() {
        ...
        $PDSH_FAST -w "$HBASEZOOKEEPERNODELIST" $*
        st=$?
