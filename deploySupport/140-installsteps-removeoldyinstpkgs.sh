...
ssh $gateway "if [ ! -d /home/gs/gridre/javahome/share ]; then mkdir -p /home/gs/gridre/javahome/share; fi && \
if [ ! -d /grid/0/gshome/gridre/javahomedefault ]; then mkdir -p /grid/0/gshome/gridre/javahomedefault; fi && \
if [ ! -d /home/gs/gridre/javahome/share/gridjdk-${GRIDJDK_VERSION} ]; then yinst inst -yes -root /grid/0/gshome/gridre/javahomedefault gridjdk-1.7.0_17.1303042057 gridjdk64-1.7.0_17.1303042057 && \
...
ln -s /grid/0/gshome/gridre/javahomedefault/share/gridjdk64-${GRIDJDK_VERSION} /home/gs/gridre/javahome/share/gridjdk64-${GRIDJDK_VERSION}; fi && \
cd /home/gs/java/jdk32 && \
rm -f current && \
ln -s /home/gs/gridre/javahome/share/gridjdk-${GRIDJDK_VERSION} current && \
cd /home/gs/java/jdk64 && \
rm -f current && \
...
ssh $gateway "sh /tmp/deploy.$cluster.remove.gateway.old.packages.sh && \
