...
execOneTestOnly() {
	...
	execOneNegCoreDfs "SF012" "90"    ls              default default  hdfsTestData/basic/smallFiles 
}

execAllTests() {
	execOneNegCoreDfs "SF012" "90"    ls              default default  hdfsTestData/basic/smallFiles 
	execOneNegCoreDfs "SF012" "91"    lsr             default default  hdfsTestData/basic/           
	execOneNegCoreDfs "SF012" "92"    cat             default default  hdfsTestData/basic/smallFiles/smallRDFile755
	execOneNegCoreDfs "SF012" "93"    copyToLocal     default default  hdfsTestData/basic/smallFiles/smallRDFile755
	execOneNegCoreDfs "SF012" "94"    get             default default  hdfsTestData/basic/smallFiles/smallRDFile755
	#execOneNegCoreDfs "SF012" "01"    wordcount       default default  hdfsTestData/basic/smallFiles/smallRDFile755
}
...
hdftSetupBadKInit "long-expired"
