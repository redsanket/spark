...
echo "DISTCP TESTCASE4: Basic local Distcp using explicit FS type HFTP and a specific file by name"
...
$HADOOP distcp hftp://$HIT_NN/tmp/in/file.txt hdfs://$HIT_NN/tmp/out 
