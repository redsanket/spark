...
public class TokenRenewalTest_doasBlock_cleanUgi_webhdfs extends Configured implements Tool {

  int failFlags = 10000; // test result init but not updated yet

  public static void main(String[] args) throws Exception {
    int ret = ToolRunner.run(new TokenRenewalTest_doasBlock_cleanUgi_webhdfs(), args);
    ...
    public void go() throws Exception {
      ...
      String retVal = ugi.doAs(new PrivilegedExceptionAction<String>() {
        public String run() throws Exception {
           ...
           jobDoas.setJarByClass(TokenRenewalTest_doasBlock_cleanUgi_webhdfs.class);
           jobDoas.setJobName("TokenRenewalTest_doasBlock_cleanUgi_webhdfs_wordcountOrigUser_job1");
           ...
           // get the fs.defaultFS and use it with "web" prepended
           String sourcefs = "web"+doasConf.get("fs.defaultFS");
           System.out.println("Using sourcefs of: "+sourcefs+"\n");
           FileInputFormat.setInputPaths(jobDoas, new Path(sourcefs+"/data/in"));
           ...
           jobDoas2.setJarByClass(TokenRenewalTest_doasBlock_cleanUgi_webhdfs.class);
           jobDoas2.setJobName("TokenRenewalTest_doasBlock_cleanUgi_webhdfs_wordcountDoasUser_job2");
           ...
           System.out.println("Using sourcefs of: "+sourcefs+"\n");
           FileInputFormat.setInputPaths(jobDoas2, new Path(sourcefs+"/data/in"));
