...
public class TokenRenewalTest_existingUgi_webhdfs {
   ...
   public static void main(String[] args) throws Exception {
     ...
     job.setJarByClass(TokenRenewalTest_existingUgi_webhdfs.class);
     job.setJobName("TokenRenewalTest_existingUgi_webhdfs_job1");
     ...
     String sourcefs = "web"+conf.get("fs.defaultFS");
     System.out.println("Using sourcefs of: "+sourcefs+"\n");
     FileInputFormat.setInputPaths(job, new Path(sourcefs+"/data/in"));
    ...
    if (renewTimeRm > 1357252344100L) 
    {
     ...
     job2.setJarByClass(TokenRenewalTest_existingUgi_webhdfs.class);
     job2.setJobName("TokenRenewalTest_existingUgi_webhdfs_job2");
     ...
     System.out.println("Using sourcefs of: "+sourcefs+"\n");
     FileInputFormat.setInputPaths(job2, new Path(sourcefs+"/data/in"));
