...
public class TokenRenewalTest_doasBlock_cleanUgi_proxyUser_CurrentUser extends Configured implements Tool {

  int failFlags = 10000; // test result init but not updated yet

  public static void main(String[] args) throws Exception {
    int ret = ToolRunner.run(new TokenRenewalTest_doasBlock_cleanUgi_proxyUser_CurrentUser(), args);
      ...
      String retVal = ugi.doAs(new PrivilegedExceptionAction<String>() {
        public String run() throws Exception {
          ...
          System.out.println("From DoasProxyUser... my Creds say i'm: " + UserGroupInformation.getCurrentUser() + " and I have " + doasCreds.numberOfTokens() + " tokens");
           ...
           jobDoas.setJarByClass(TokenRenewalTest_doasBlock_cleanUgi_proxyUser_CurrentUser.class);
           jobDoas.setJobName("TokenRenewalTest_doasBlock_cleanUgi_proxyUser_CurrentUser_wordcountOrigUser_job1");
           ...
           jobDoas2.setJarByClass(TokenRenewalTest_doasBlock_cleanUgi_proxyUser_CurrentUser.class);
           jobDoas2.setJobName("TokenRenewalTest_doasBlock_cleanUgi_proxyUser_CurrentUser_wordcountDoasUser_job2");
